...
<figure>
  ...
  <figcaption><b>Figure X:</b> The trained random forest model applied to a validation dataset with known spectroscopic redshifts (Zspec). The photometric redshift (Zphot) is the output prediction of the model, with the black line showing Zphot=Zspec. </figcaption>
</figure>
</div>
